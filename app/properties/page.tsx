  ...
  return (
    <main className="mx-auto max-w-7xl px-4 pb-20 pt-28 md:px-6">
      <div className="mb-10 max-w-3xl">
        ...
        <h1 className="mt-4">Explore Properties Across Ebonyi State</h1>
        <p className="mt-4 text-lg leading-8 text-brand-gray">Filter by neighbourhood, city, price, and verification status. Only active listings appear in public search.</p>
      </div>
      <div className="grid gap-8 lg:grid-cols-[300px_1fr]">
        <FilterSidebar />
        <div className="space-y-6">
          <div className="flex items-center justify-between rounded-3xl border border-brand-border bg-white px-5 py-4">
