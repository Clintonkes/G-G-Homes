  ...
  return (
    <main className="mx-auto max-w-5xl px-4 pb-20 pt-28 md:px-6">
      ...
      <div className="space-y-6 text-lg leading-8 text-brand-gray">
        <p>G &amp; G Homes LTD was built to remove the friction, opacity, and repeated agent fees that often slow down rentals in Nigeria.</p>
        <p>This rebuild transforms the company’s original verification landing page and WhatsApp-native workflow into a complete web marketplace for direct landlord-to-tenant rentals.</p>
